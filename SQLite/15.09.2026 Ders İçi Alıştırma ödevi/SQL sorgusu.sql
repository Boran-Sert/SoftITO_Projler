...
-- 3. Yaşı 10 olan bir üye ekleme denemesi
INSERT INTO uyeler (ad, yas) VALUES ('Ali Can', 10);
-- Açıklama: "CHECK constraint failed: yas > 13" hatası döner. 
-- Çünkü tabloda yaşın 13'ten büyük olması kuralı (CHECK) tanımlanmıştır.

-- 4. Olmayan bir uye_id (ör. 99) ile ödünç kaydı denemesi
INSERT INTO odunc (uye_id, kitap_id, gun) VALUES (99, 1, 14);
-- Açıklama: "FOREIGN KEY constraint failed" hatası döner. 
...
UPDATE uyeler SET eposta = 'test@gmail.com' WHERE id = 1;

UPDATE uyeler SET eposta = 'test@gmail.com' WHERE id = 2;
